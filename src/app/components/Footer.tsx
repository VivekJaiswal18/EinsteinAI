    ...
    <div>
      ...
      <footer className=" border-t !w-full py-10 my-9 justify-between flex items-center">
        <div className=" flex  gap-2 text-sm font-medium items-center">
          ...
          <span className=" w-1 h-1 rounded-full text-black" />
        ...
        <span className="text-black font-light text-sm flex justify-center items-center">
          {new Date().getFullYear()} © EinsteinAI 
        </span>
